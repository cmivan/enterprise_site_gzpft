...
<td width="115" height="28" align="right">请先输入<?php echo $passTitle;?>密码：</td><td><input type="password" name="pass" id="pass"></td><td width="80"><input name="提交" type="submit" class="button" id="edit_back" value="验证<?php echo $passTitle;?>密码"/></td>
</tr>
