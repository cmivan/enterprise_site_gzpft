...
<tr class="forumRow">
  ...
  <td><table border="0" cellpadding="0" cellspacing="1" class="forum2">
    ...
    <tr class="forumRow">
        ...
        <td><input name="price_vip" type="text" id="price_vip" value="<?php echo $rs['price_vip']?>"> <?php echo cm_form_radio('i_type',$i_type,$rs['i_type']);?><span class="red">请选择相应的库存单位，否则会被视为 <strong>【<a href="<?php echo site_system('products/manage');?>?nottpe=no" target="_blank">未分类产品</a>】</strong>！</span></td>
    </tr>
