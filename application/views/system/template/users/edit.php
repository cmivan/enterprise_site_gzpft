...
<tr class="forumRow">
<td align="right">称呼：</td><td><input name="nicename" type="text" id="nicename" value="<?php
 echo $rs['nicename']?>" size="45">
</td></tr>
...
<td><input name="email" type="text" id="email" value="<?php
 echo $rs['email']?>" size="45">
</td></tr>

<tr class="forumRow">
<td align="right">手机：</td>
<td><input name="mobile" type="text" id="mobile" value="<?php
 echo $rs['mobile']?>" size="45">
</td></tr>
...
<input name="addr" type="text" id="addr" value="<?php
 echo $rs['addr']?>" size="45">
...
<tr class="forumRow">
  ...
  <td height="24">
    ...
    <div class="red" style="border-bottom:#CCC 1px solid; padding-bottom:5px; margin-bottom:6px;">注：1、在这里添加的用户，默认登录密码是：<?php
 echo $seo['product.pass'];?><br>
    &nbsp;&nbsp;&nbsp;&nbsp;2、打上勾后，这个用户的密码将自动初始到默认密码</div>
    <?php
 echo cm_form_checkbox('初始化密码','repass',0);?>
    </div>
    </td></tr>
</tbody>
</table>
